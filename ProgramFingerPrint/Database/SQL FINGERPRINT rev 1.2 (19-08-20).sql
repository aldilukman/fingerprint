...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2020 at 02:27 AM
...
INSERT INTO `registrasi` (`Message`) VALUES
('-');
...
--
ALTER TABLE `hystory`
  MODIFY `IDHYSTORY` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
...
--
ALTER TABLE `jadwalkuliah`
  MODIFY `IDJADWALKULIAH` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `matakuliah`
--
ALTER TABLE `matakuliah`
  MODIFY `IDMATAKULIAH` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
